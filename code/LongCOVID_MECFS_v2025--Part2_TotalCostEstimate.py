...
long_covid_file_path = f'{folder_path}long_covid_cases_popold_040_058_v14.csv'
...
def generate_recovery_days():
    ...
    short_term_prob = 0.8  # 87% probability of short-term duration
...
#     society_loss_values = {
#         '0-19': 76, '20-39': 137, '40-59': 152, '60+': 104
#     }
#     personal_loss_values = {
#         '0-19': 122, '20-39': 196, '40-59': 203, '60+': 130
#     }
#     employer_loss_values = {
#         '0-19': 28, '20-39': 102, '40-59': 119, '60+': 55
#     }
...
# **Save results**
output_file = 'F:/Corona/long_covid_and_mecfs_daily_costsv2025v21_popold_l040_m058_v18.csv'
